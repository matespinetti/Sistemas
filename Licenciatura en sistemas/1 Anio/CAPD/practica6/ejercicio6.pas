...
procedure procesar (pi : lista; duracionPromedio : real; costoConstruccionPromedio: real; var max1: max; var c: contadorRangos; var cantMayorDuracion : integer );
var
	costoTotal : real;
begin
...
var
	...
	max1 : max;
	c: contadorRangos;
	duracionPromedio, costoConstruccionPromedio: real;
	cantMayorDuracion : integer;

begin
	max1.costo := -1;
	crearLista(pi);
	cargarSondas(pi, pu, duracionPromedio, costoConstruccionPromedio);
	procesar(pi, duracionPromedio, costoConstruccionPromedio, max1, c, cantMayorDuracion);
